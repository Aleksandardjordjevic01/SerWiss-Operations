    ...
    <section id="home" className="relative h-screen w-full overflow-hidden flex items-center px-6 md:px-12 lg:px-20">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        >
          ...
          <h2 className="font-sans font-light text-justify text-[#b8dcf5] text-base md:text-lg max-w-lg leading-relaxed">
            Your Strategic Partner for value-adding Financial Services, nearshored from Serbia
          </h2>
